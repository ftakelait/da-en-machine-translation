...
def main():
    ...
    # new datasets
    raw_datasets = load_from_disk("danish_english_dataset")
...
#     if args.source_lang not in raw_datasets["train"]["source"]:
#         raise ValueError(f"Language {args.source_lang} not found in dataset")
    
#     if args.target_lang not in raw_datasets["train"]["target"]:
